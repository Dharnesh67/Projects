    ...
    <div>
      ...
      <div className="content flex flex-col justify-center items-center h-[95vh] w-screen text-sm md:text-lg"> 
        ...
        <div className="buttons my-5 flex justify-evenly w-screen" >
          <button className=' flex items-center gap-3 md:px-2 md:py-2 rounded-sm font-bold bg-teal-300 hover:bg-teal-500'>
          ...
          <div className="input flex  gap-2 ">
            ...
            <button onClick={send} className='bg-teal-400 md:px-3  rounded-sm font-bold hover:bg-teal-500 '>Join</button>
          </div>
          
        </div>
      </div>
      <footer
      class="absolute  w-screen bg-teal-400 text-slate-800 font-bold h-[4vh] bottom-0 flex items-center justify-center text-sm md:text-lg"
    >
