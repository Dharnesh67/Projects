...
const Editform = ({ params }) => {  
  ...
  const data = async () => {// data fetch from api
    ...
    <div>
      <p className="p-2 font-bold capitalize text-xl flex gap-2 items-center justify-between ">
        ...
        <div className="text-2xl text-primary">
           {params.slug}:{formdata.formTitle ? formdata.formTitle : "Title"}
        </div>
        <div className="flex gap-2">
          <Link href={"/preview/" + params.slug}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 h-screen">
        ...
        <div
          ...
          style={{ background: bg }}
        >
          {/* This Is the Form Ui Section Where Our Form structure Will BE visible*/}
          {
            <FormUi
              formdata={formdata}
              update={update}
