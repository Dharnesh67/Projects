        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center ">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-3xl font-extrabold sm:text-5xl">
              ...
              <strong className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r text-4xl from-primary to-purple-500 sm:block"> make forms in seconds.</strong>
            </h1>
            <p className="m-4 sm:text-md">
